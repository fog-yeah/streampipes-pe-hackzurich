...
import static org.streampipes.config.ConfigKeys.*;
...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID= "pe/org.streampipes.hackzurich";

  Config() {
    config = SpConfig.getSpConfig("pe/org.streampipes.hackzurich");

    config.register(HOST, "hackzurich", "Hostname for the pe hackzurich");
